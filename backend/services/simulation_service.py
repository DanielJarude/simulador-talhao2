# Tabela agronômica calibrada por cultura
...
def calculate_what_if_impact(n_kg: float, w_mm: float, pest_pct: float, area_ha: float = 42.54, crop: str = "Soja / Milho Safrinha"):

...
class Settings(BaseSettings):
    model_config = SettingsConfigDict(
        # O `.env` é resolvido contra a PASTA DO MÓDULO (Back/.env) e,
        # como reforço, contra o CWD. Assim o servidor perde as credenciais
        # CDSE se for iniciado de `Back/` OU da raiz do repositório.
        # (Antes: `env_file=".env"` — relativo ao CWD → Back/.env era
